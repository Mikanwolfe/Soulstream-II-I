...
echo set/a p1.%tmpa%.sr=0 >> output.txt
echo set/a p1.%tmpa%.sv=0 >> output.txt
echo set/a p1.%tmpa%.sc=0 >> output.txt
echo set/a p1.%tmpa%.sx=0 >> output.txt
echo set/a p1.%tmpa%.sa=0 >> output.txt
echo set/a p1.%tmpa%.sb=0 >> output.txt
echo set/a p1.%tmpa%.sp=0 >> output.txt
echo set p1.%tmpa%.sd=0 >> output.txt
echo set/a p2.%tmpa%.sr=0 >> output.txt
echo set/a p2.%tmpa%.sv=0 >> output.txt
echo set/a p2.%tmpa%.sc=0 >> output.txt
echo set/a p2.%tmpa%.sx=0 >> output.txt
echo set/a p2.%tmpa%.sa=0 >> output.txt
echo set/a p2.%tmpa%.sb=0 >> output.txt
echo set/a p2.%tmpa%.sp=0 >> output.txt
echo set p2.%tmpa%.sd=0 >> output.txt
echo.  >> output.txt
