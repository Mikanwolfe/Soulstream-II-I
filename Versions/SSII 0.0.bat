...
color 0F
title Soulstream II 0.1 by Wolfe Lumi
...
if exist graphics.bat ren saves.bat graphics.ssii
...
echo.
echo.
echo.      Soulstream II 0.1 - The better beginning of even brighter beginnings.
echo.
echo.
echo.
echo.
...
for %%A in (p1,p2) do (
	for %%B in (sc,sx,hpa,mpa,dfa,bal,chp,cmp) do (
...
::abilities
for %%A in (p1,p2) do (
	for %%B in (ast,adx,ain,alk,awl,adp,adf,acm,acr,amp) do (
		echo set/a %%A.%%B=!%%A.%%B!>> saves.bat
	)
)
::skills, passive - masteries
...
set/a p1.df=%p1.cdf%+%p1.dfa% + ((%p1.cdf%+%p1.dfa%) * %p1.adf% /10) + (%p1.str% / 10)
set/a p2.df=%p2.cdf%+%p2.dfa% + ((%p2.cdf%+%p2.dfa%) * %p2.adf% /10) + (%p2.str% / 10)
set/a p1.dp=%p1.cdp%+(%p1.dx% / 2) + ((%p1.cdp%+(%p1.dx% / 2) * %p1.adp% /10))
set/a p2.dp=%p2.cdp%+(%p2.dx% / 2) + ((%p2.cdp%+(%p2.dx% / 2) * %p2.adp% /10))

set/a p1.cr=100 - %p1.acr% - (%p1.lk% / 40)
set/a p2.cr=100 - %p2.acr% - (%p2.lk% / 40)
set/a p1.cm=%p1.crm% + (%p1.crm% * %p1.acm% / 30) + (%p1.lk% / 30)
set/a p2.cm=%p2.crm% + (%p2.crm% * %p2.acm% / 30) + (%p2.lk% / 30)
goto:eof
...
set/a p1.lk=%p1.luk% + %p1.cluk% + (%p1.luk% * %p1.alk% / 10)
set/a p1.wl=%p1.wil% + %p1.cwil% + (%p1.wil% * %p1.awl% / 10)
set/a p1.bl=%p1.bal% + (%p1.dx% / 20) + (%p1.wl% / 20)
if %p1.bal% gtr 400 set p1.bal=400
::p2
set/a p2.st=%p2.str% + %p2.cstr% + (%p2.str% * %p2.ast% / 10)
set/a p2.dx=%p2.dex% + %p2.cdex% + (%p2.dex% * %p2.adx% / 10)
set/a p2.in=%p2.int% + %p2.cint% + (%p2.int% * %p2.ain% / 10)
set/a p2.lk=%p2.luk% + %p2.cluk% + (%p2.luk% * %p2.alk% / 10)
set/a p2.wl=%p2.wil% + %p2.cwil% + (%p2.wil% * %p2.awl% / 10)
set/a p1.bl=%p2.bal% + (%p2.dx% / 20) + (%p2.wl% / 20)
if %p2.bal% gtr 400 set p2.bal=400
...
set/a p1.dp=%p1.cdp%+(%p1.dx% / 2) + ((%p1.cdp%+(%p1.dx% / 2) * %p1.adp% /10))
set/a p2.dp=%p2.cdp%+(%p2.dx% / 2) + ((%p2.cdp%+(%p2.dx% / 2) * %p2.adp% /10))
set/a p1.cr=%p1.crr% + %p1.acr% + (%p1.lk% / 40)
set/a p2.cr=%p2.crr% + %p2.acr% + (%p2.lk% / 40)
set/a p1.cm=%p1.crm% + (%p1.crm% * %p1.acm% / 30) + (%p1.lk% / 30)
set/a p2.cm=%p2.crm% + (%p2.crm% * %p2.acm% / 30) + (%p2.lk% / 30)
set/a p1.fir.c=1
set/a p2.fir.c=1
...
set/a  skill.6.sc=80
set/a  skill.7.sc=90
set/a  skill.8.sc=110
set/a  skill.9.sc=130
set/a skill.10.sc=150
set/a skill.11.sc=180
set/a skill.12.sc=200
set/a skill.13.sc=340
set/a skill.14.sc=400
set/a skill.15.sc=0
::skill.rank.sx (skill experience cost)
set/a  skill.0.sx=200
set/a  skill.1.sx=20
set/a  skill.2.sx=30
set/a  skill.3.sx=40
set/a  skill.4.sx=60
...
set/a  skill.7.sx=110
set/a  skill.8.sx=120
set/a  skill.9.sx=140
set/a skill.10.sx=160
set/a skill.11.sx=180
set/a skill.12.sx=240
set/a skill.13.sx=350
set/a skill.14.sx=400
set/a skill.15.sx=0
...
set/a p1.hp+=%p1.skl.reg.sl% * 5 / 10
set/a p1.mp+=%p1.skl.rum.sl% * 5 / 10
set/a p2.hp+=%p1.skl.reg.sl% * 5 / 10
set/a p2.mp+=%p1.skl.rum.sl% * 5 / 10
...
set/a adfc=(%p1.cdf%+%p1.dfa%) * %p1.adf% /10 + (%p1.str% / 10)
...
echo.                     Health: +%p1.chp%	+ %p1.hpa%	+ %hp%
echo.                       Mana: +%p1.cmp%	+ %p1.mpa%	+ %mp%
echo.
echo.
echo. Q to go back
echo --------------------------------------------------------------------------------
...
:grid.p2
::Regen and Rumination kick in!
set/a p2.hp+=%p2.skl.reg.sl% * 5 / 10
set/a p2.mp+=%p2.skl.rum.sl% * 5 / 10
set/a p1.hp+=%p1.skl.reg.sl% * 5 / 10
set/a p1.mp+=%p1.skl.rum.sl% * 5 / 10
...
set/a adfc=(%p2.cdf%+%p2.dfa%) * %p2.adf% /10 + (%p2.str% / 10)
...
echo.
echo.                             Class    Skills    Stats
echo.                     Health: +%p2.chp%	+ %p2.hpa%	+ %hp%
echo.                       Mana: +%p2.cmp%	+ %p2.mpa%	+ %mp%
echo.
echo.
echo. Q to go back
echo --------------------------------------------------------------------------------
...
:p1.skill.fus
set/a skilldrain=%p1.fus.sm%  40 / 10
...
call:funct.acc %p1.fus.sa% p1 p2
if %funct.return%==1 goto:p1.skill.fus.m
set/a critchance=%p1.cr% + 20
if critchance gtr %ssii.crl% set/a critchance=%ssii.crl%
call:funct.random 1 100
set/a crit=0
if %funct.return% leq %critchance% set/a crit=1
set/a dmg=%p1.fus.sm% * 50 / 10
if %crit%==1 set/a dmg=%dmg% * %p1.cm% / 10
call:funct.damage %dmg% %p1.fus.sb% p1 p2
set/a p2.hp-=%funct.return%
call:graphics fus p1 0 %funct.return% %crit% %skilldrain%
set/a p1.td+=%funct.return%
goto:grid.p2
:p1.skill.fus.m
::miss!! ha!
call:graphics fus p1 1 0 0 %skilldrain%
goto:grid.p2
...
::magic claw!
:p1.skill.mgc
set/a skilldrain=%p1.mgc.sm% * 85 / 10
set/a skilldrain=%skilldrain% - (%skilldrain% * %p1.amp% /100)
if %p1.mp% lss %skilldrain% set ssii.errormessage=You do not have enough MP & goto:grid.p1
set ssii.errormessage=
set/a p1.mp-=%skilldrain%
call:funct.acc %p1.mgc.sa% p1 p2
if %funct.return%==1 goto:p1.skill.mgc.m
set/a critchance=%p1.cr% * 80 / 100
if critchance lss 20 set/a critchance=20
call:funct.random 1 %critchance% 
set/a dmg=%p1.mgc.sm% * 100 / 10
if %funct.return% leq 10 set/a dmg=%dmg% * %p1.cm% / 10
set/a crit=0
if %funct.return% leq 10 set/a crit=1
call:funct.damage %dmg% %p1.mgc.sb% p1 p2
set/a p2.hp-=%funct.return%
call:graphics mgc p1 0 %funct.return% %crit% %skilldrain%
set/a p1.td+=%funct.return%
goto:grid.p2
:p1.skill.mgc.m
::miss!! ha!
call:graphics mgc p1 1 0 0 %skilldrain%
goto:grid.p2
:p2.skill.mgc
set/a skilldrain=%p2.mgc.sm% * 85 / 10
set/a skilldrain=%skilldrain% - (%skilldrain% * %p2.amp% /100)
if %p2.mp% lss %skilldrain% set ssii.errormessage=You do not have enough MP & goto:grid.p2
set ssii.errormessage=
set/a p2.mp-=%skilldrain%
call:funct.acc %p2.mgc.sa% p2 p2
if %funct.return%==1 goto:p2.skill.mgc.m
set/a critchance=%p2.cr% * 80 / 100
if critchance lss 20 set/a critchance=20
call:funct.random 1 %critchance% 
set/a dmg=%p2.mgc.sm% * 100 / 10
if %funct.return% leq 10 set/a dmg=%dmg% * %p2.cm% / 10
set/a crit=0
if %funct.return% leq 10 set/a crit=1
call:funct.damage %dmg% %p2.mgc.sb% p1 p2
set/a p1.hp-=%funct.return%
call:graphics mgc p2 0 %funct.return% %crit% %skilldrain%
set/a p2.td+=%funct.return%
goto:grid.p1
:p2.skill.mgc.m
::miss!! ha!
call:graphics mgc p2 1 0 0 %skilldrain%
goto:grid.p1
::Magic Arrow! PEW!
:p1.skill.mga
set/a skilldrain=%p1.mga.sm% * 60 / 10
set/a skilldrain=%skilldrain% - (%skilldrain% * %p1.amp% /100)
if %p1.mp% lss %skilldrain% set ssii.errormessage=You do not have enough MP & goto:grid.p1
set ssii.errormessage=
set/a p1.mp-=%skilldrain%
call:funct.acc %p1.mga.sa% p1 p2
if %funct.return%==1 goto:p1.skill.mga.m
set/a critchance=%p1.cr% * 50 / 100
if critchance lss 20 set/a critchance=20
call:funct.random 1 %critchance% 
set/a dmg=%p1.mga.sm% * 70 / 10
if %funct.return% leq 10 set/a dmg=%dmg% * %p1.cm% / 10
set/a crit=0
if %funct.return% leq 10 set/a crit=1
call:funct.damage %dmg% %p1.mga.sb% p1 p2
set/a p2.hp-=%funct.return%
call:graphics mga p1 0 %funct.return% %crit% %skilldrain%
set/a p1.td+=%funct.return%
goto:grid.p2
:p1.skill.mga.m
::miss!! ha!
call:graphics mga p1 1 0 0 %skilldrain%
goto:grid.p2
::player2
:p2.skill.mga
set/a skilldrain=%p2.mga.sm% * 60 / 10
set/a skilldrain=%skilldrain% - (%skilldrain% * %p2.amp% /100)
if %p2.mp% lss %skilldrain% set ssii.errormessage=You do not have enough MP & goto:grid.p2
set ssii.errormessage=
set/a p2.mp-=%skilldrain%
call:funct.acc %p2.mga.sa% p2 p1
if %funct.return%==1 goto:p2.skill.mga.m
set/a critchance=%p2.cr% * 50 / 100
if critchance lss 20 set/a critchance=20
call:funct.random 1 %critchance% 
set/a dmg=%p2.mga.sm% * 70 / 10
if %funct.return% leq 10 set/a dmg=%dmg% * %p2.cm% / 10
set/a crit=0
if %funct.return% leq 10 set/a crit=1
call:funct.damage %dmg% %p2.mga.sb% p2 p1
set/a p1.hp-=%funct.return%
call:graphics mga p2 0 %funct.return% %crit% %skilldrain%
set/a p2.td+=%funct.return%
goto:grid.p1
:p2.skill.mga.m
::miss!! ha!
call:graphics mga p2 1 0 0 %skilldrain%
goto:grid.p1
...
echo --------------------------------------------------------------------------------
timeout 1 >nul
set/a p2.sc+=%p2.td% / 4 + 250 + (%p2.lk%/10)
set/a p2.sx+=%p2.td% / 4 + 175 + (%p2.wl%/10)
set/a p1.sc+=%p1.td% / 4 + 75 + (%p1.lk%/10)
set/a p1.sx+=%p1.td% / 4 + 200 + (%p1.wl%/10)
set/a p2sc=%p2.td% / 4 + 250 + (%p2.lk%/10)
set/a p2sx=%p2.td% / 4 + 175 + (%p2.wl%/10)
set/a p1sc=%p1.td% / 4 + 175 + (%p1.lk%/10)
set/a p1sx=%p1.td% / 4 + 200 + (%p1.wl%/10)
cls
echo --------------------------------------------------------------------------------
echo.
echo.                          S o u l s t r e a m   I I
...
echo --------------------------------------------------------------------------------
timeout 2 >nul
set/a p1.sc+=%p1.td% / 4 + 250 + (%p1.lk%/10)
set/a p1.sx+=%p1.td% / 4 + 175 + (%p1.wl%/10)
set/a p2.sc+=%p2.td% / 4 + 175 + (%p2.lk%/10)
set/a p2.sx+=%p2.td% / 4 + 200 + (%p2.wl%/10)
set/a p1sc=%p1.td% / 4 + 250 + (%p1.lk%/10)
set/a p1sx=%p1.td% / 4 + 175 + (%p1.wl%/10)
set/a p2sc=%p2.td% / 4 + 175 + (%p2.lk%/10)
set/a p2sx=%p2.td% / 4 + 200 + (%p2.wl%/10)
cls
echo --------------------------------------------------------------------------------
echo.
echo.                          S o u l s t r e a m   I I
...
set/a p1.dex+=%p1.skl.exp.sl% * 20 / 10
...
set/a p1.skl.reg.ss+=%p1.skl.reg.sl% * 10 / 10
goto:p1.shop.stats
...
::Change the 5 to affect how much each rank gives
set/a p1.skl.rum.ss+=%p1.skl.rum.sl% * 10 / 10
goto:p1.shop.stats
...
set/a p2.dex+=%p2.skl.exp.sl% * 20 / 10
...
::Change the 5 to affect how much each rank gives
set/a p2.skl.reg.ss+=%p2.skl.reg.sl% * 10 / 10
goto:p2.shop.stats
...
::Change the 5 to affect how much each rank gives
set/a p2.skl.rum.ss+=%p2.skl.rum.sl% * 10 / 10
goto:p2.shop.stats
