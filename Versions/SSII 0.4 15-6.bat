...
set/a mp=!%1.in!/2
set/a hp=!%1.wl!/2
set/a astc=!%1.str! * !%1.ast! / 10
set/a adxc=!%1.dex! * !%1.adx! / 10
set/a ainc=!%1.int! * !%1.ain! / 10
set/a alkc=!%1.luk! * !%1.alk! / 10
set/a awlc=!%1.wil! * !%1.awl! / 10
...
:p1.inventory
::presets for testing
set itemslot_1=2 1 20 0 0
set itemslot_2=2 1 0 50 0
set itemslot_3=0
set itemslot_4=2 1 20 20 1
set itemslot_5=1 2 3 Thunder 30 0 0
set itemslot_6=1 1 1 Moses 0 0 500 0 0 0 0 0 0
set itemslot_7=1 2 2 Jason 0 0 500 0 0 0 0 0 0
set itemslot_8=2 1 100 200 0
set itemslot_9=2 1 50 50 1

for /l %%G in (1,1,9) do (
	set itemcall=!itemslot_%%G!
	call:funct.itemid
...
call:inv.itemSelect %menu%
goto:eof

:inv.itemSelect
for /l %%G in (1,1,9) do (
	if "!sinv.%%G!"=="!sinv.%1!" goto p1.inventory.pre
)
