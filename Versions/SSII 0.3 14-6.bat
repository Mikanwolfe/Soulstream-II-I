...
for %%G in (1,2) do (
	...
	if !ssii.%%G!==11 set n%%G=Kydos
	if !ssii.%%G!==11 set n%%G=Ryuu
	if !ssii.%%G!==11 set n%%G=Soul
)
...
echo.
echo.
echo.       Soulstream II %ssii.version% - The Kydos and Ryuu connected by the Soulstream.
echo.
echo.
echo.
echo.
...
echo.
echo.
echo.                    !tmp!, the descendant of !%1.ab.d!
echo --------------------------------------------------------------------------------
echo.
echo.                              ---Store--- 
echo.
