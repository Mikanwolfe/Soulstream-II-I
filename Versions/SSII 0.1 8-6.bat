...
::=========================================================================================================
call:funct.random 1 2
goto:grid.p%funct.return%
:grid.p1
::Regen and Rumination kick in!
set/a p1.hp+=%p1.skl.hp.ss%
set/a p1.mp+=%p1.skl.mp.ss%
set/a p2.hp+=%p2.skl.hp.ss%
set/a p2.mp+=%p2.skl.mp.ss%
...
if !p1.c%menu%.a!==att goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==hea goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==res goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==enl goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==cla goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==shm goto:p1.skill.!p1.c%menu%.a!
if !p1.c%menu%.a!==wit goto:p1.skill.!p1.c%menu%.a!
...
if !p2.c%menu%.a!==att goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==hea goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==res goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==enl goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==cla goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==shm goto:p2.skill.!p2.c%menu%.a!
if !p2.c%menu%.a!==wit goto:p2.skill.!p2.c%menu%.a!
